  ...
  const controller = new CameraController({
    ...
    streamingOptions  : {
      ...
      video                 : {
        ...
        // The stream is passed through untouched (`-c:v copy`), so we must
        // advertise what the cameras actually send rather than a safe minimum.
        // Measured on a Eufy indoor cam: h264 High profile, 1920x1080, 15fps.
        // Declaring only Baseline told iOS to expect something the camera
        // never sends.
        codec       : {
